...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form action="{{ route('barang.store') }}" method="POST">
            ...
            <div class="form-group">
                <label>Harga</label>
                <input type="number" name="barang_harga" class="form-control" value="{{ old('barang_harga') }}" required>
            </div>
            <div class="form-group">
                <label>Stok</label>
                <input type="number" name="barang_stok" class="form-control" value="{{ old('barang_stok') }}" required>
            </div>
